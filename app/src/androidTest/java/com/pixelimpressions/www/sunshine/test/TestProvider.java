...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.pixelimpressions.www.sunshine.app/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.pixelimpressions.www.sunshine.app/weather
        assertEquals(WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.pixelimpressions.www.sunshine.app/weather/94074
        ...
        // content://com.pixelimpressions.www.sunshine.app/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.pixelimpressions.www.sunshine.app/weather
        assertEquals(WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.pixelimpressions.www.sunshine.app/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.pixelimpressions.www.sunshine.app/location
        assertEquals(LocationEntry.CONTENT_TYPE, type);

        // content://com.pixelimpressions.www.sunshine.app/location/1
        type = mContext.getContentResolver().getType(LocationEntry.buildLocationUri(1L));
        // vnd.android.cursor.item/com.pixelimpressions.www.sunshine.app/location
    ...
    public void insertKalamazooData() {
        ...
        Log.d(LOG_TAG, "locationRowId value " + locationRowId);
