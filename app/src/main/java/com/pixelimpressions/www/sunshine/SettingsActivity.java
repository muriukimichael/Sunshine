...
public class SettingsActivity extends PreferenceActivity
    ...
    //since we use the preference change to initially populate the summary field
    //we ignore that change at the start of the activity
    ...
    private void bindPreferenceSummaryToValue(Preference preference) {
        ...
        //updating this tells us that the preference Activity has ran before
